<?php
  ...
  if ($nama_supplier) {
    $data = $db->find(
      "supplier",
      ["nama_supplier" => cRegex($nama_supplier)]
    );
  } else {
...
<div class="main-header">
  ...
  <form action="?p=supplier/index" class="mt-20">
    ...
    <input 
      ...
      class="input-search" placeholder="Cari supplier" 
      value="<?= $nama_supplier ?>">
    ...
    foreach ($data as $key => $value) {
      ?>
        <tr>
          ...
          <td>
              <a href="?p=supplier/delete&id=<?= $value->_id ?>"><b>Delete</b></a> | 
              <a href="?p=supplier/edit&id=<?= $value->_id ?>"><b>Update</b></a>
          </td>
        </tr>
      <?php
    }
