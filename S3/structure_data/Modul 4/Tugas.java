...
public class Tugas {    
   ...
   //------------------------------------------------------
    ...
    //------------------------------------------------------
    public static void mencariDataBiner(formatBiodata biodataMahasiswa[], String kataKunci)
    {
        int lokasi=-1;
        ...
        atas = 0;
        bawah = N-1; // 2
        tengah = (atas + bawah) / 2; // 1
        while ((statusKetemu == false) && (atas != bawah-1))
        {
    ...
    public static void main(String[] args) { 
        ...
        mencariDataBiner(biodataMahasiswa, kataKunci);
