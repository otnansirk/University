...
public class Praktik_4 {    
    ...
    public static void hapusData(formatBiodata biodataMahasiswa[], int index) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            dataBaru[p] = biodataMahasiswa[i];
            p++;
        }
        System.out.println("\nDATA SESUDAH DIHAPUS \n");
        tampilData(dataBaru, p);
    }
    ...
    public static void main(String[] args) { 
        ...
        System.out.println("Coba hapus data pada baris tertentu");
        int dataKe = masukan.nextInt();
        hapusData(biodataMahasiswa, dataKe);
